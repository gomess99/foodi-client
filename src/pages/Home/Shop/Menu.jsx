...
const Menu = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        console.log("erro fetching data", erro);
      }
    };
  ...
  const intexOfLastItem = currentPage * itemsPerPage;
  const indexOfFirstItem = intexOfLastItem - itemsPerPage;
  const currentItems = filteredItems.slice(indexOfFirstItem, intexOfLastItem)
